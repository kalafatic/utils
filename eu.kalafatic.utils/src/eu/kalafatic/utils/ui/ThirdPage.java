...
public class ThirdPage extends FormPage {
	...
	private void createSectionWithLinks(IManagedForm mform, String title,
		...
		for (int i = 1; i <= nlinks; i++) {
			toolkit.createHyperlink(client,
					Messages.getString("ThirdPage.link") + i, SWT.WRAP); //$NON-NLS-1$
		}
	}
	...
	private void createSectionWithControls(IManagedForm mform, String title,
		...
		toolkit.createButton(client,
				Messages.getString("ThirdPage.button1"), SWT.RADIO); //$NON-NLS-1$
		toolkit.createButton(client,
				Messages.getString("ThirdPage.button2"), SWT.RADIO); //$NON-NLS-1$
		toolkit.createButton(client, Messages.getString("ThirdPage.button3"), //$NON-NLS-1$
				SWT.RADIO);
		toolkit.createButton(client,
				Messages.getString("ThirdPage.checkbox"), SWT.CHECK); //$NON-NLS-1$
	}
	...
	private void createMixedSection(IManagedForm mform, String title,
		...
		link = toolkit.createHyperlink(client,
				Messages.getString("ThirdPage.link2"), //$NON-NLS-1$
				SWT.WRAP);
		gd = new GridData();
		gd.horizontalSpan = 2;
		link.setLayoutData(gd);
